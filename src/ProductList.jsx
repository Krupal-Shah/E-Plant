...
function ProductList() {
    ...
    const cartItems = useSelector(state => state.cart.items); // Correctly fetching cart items from Redux store
    const totalQuantity = cartItems.reduce((total, item) => total + item.quantity, 0);
    const [addedToCart, setAddedToCart] = useState({}); // State to keep track of products added to cart
    const [isCartVisible, setCartVisible] = useState(false);

    const handleAddToCart = (product) => {
        dispatch(addItem(product)); // Assuming quantity of 1 for each added item
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <div>
                        <a href="#" style={styleA} onClick={toggleCartVisibility}>
                            <h1 className='cart'>
            ...
            {isCartVisible && <Cart onContinueShopping={toggleCartVisibility} />}
